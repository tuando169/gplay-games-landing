...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'about.description': 'Chúng tôi là một đội ngũ đam mê gồm các nhà phát triển game, nghệ sĩ và những người mơ ước, tận tâm tạo ra những trải nghiệm game huyền thoại kết nối mọi người từ khắp nơi trên thế giới.',
    ...
    'about.gallery.title': 'Văn Phòng Của Chúng Tôi',
    'about.gallery.description': 'Khám phá không gian làm việc sáng tạo nơi những game huyền thoại được sinh ra',
    'about.gallery.alt1': 'Studio phát triển game hiện đại với nhiều màn hình',
    'about.gallery.alt2': 'Đội ngũ sáng tạo cùng nhau thiết kế game',
    'about.gallery.alt3': 'Không gian làm việc với ánh sáng RGB chuyên nghiệp',
    'about.gallery.alt4': 'Khu vực nghỉ ngơi thoải mái với artwork game',
    'about.gallery.alt5': 'Nhà phát triển đang làm việc với code và mô hình 3D',
    'about.gallery.alt6': 'Khu vực giải trí với máy arcade và bàn bóng bàn',
    'about.join.title': 'Tham Gia Câu Chuyện Của Chúng Tôi',
    'about.join.description': 'Chúng tôi luôn tìm kiếm những người tài năng, đam mê để gia nhập đội ngũ. Hãy là một phần trong việc tạo ra thế hệ game huyền thoại tiếp theo.',
    'about.join.button': 'Xem Các Vị Trí Tuyển Dụng',
  ...
  en: {
    ...
    'about.description': "We're a passionate team of game developers, artists, and dreamers dedicated to creating legendary gaming experiences that bring people together from around the world.",
    ...
    'about.gallery.title': 'Our Office',
    'about.gallery.description': 'Explore the creative workspace where legendary games are born',
    'about.gallery.alt1': 'Modern game development studio with multiple monitors',
    'about.gallery.alt2': 'Creative team collaborating on game design',
    'about.gallery.alt3': 'Workspace with professional RGB lighting',
    'about.gallery.alt4': 'Casual meeting area with game artwork',
    'about.gallery.alt5': 'Developers working with code and 3D models',
    'about.gallery.alt6': 'Recreation area with arcade machines and ping pong table',
    'about.join.title': 'Join Our Story',
    'about.join.description': "We're always looking for talented, passionate people to join our team. Be part of creating the next generation of legendary games.",
    'about.join.button': 'View Open Positions',
