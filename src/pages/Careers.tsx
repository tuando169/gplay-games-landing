...
const Careers = () => {
  ...
  const officeImages = [
    { src: office1, alt: t('careers.gallery.alt1') },
    { src: office2, alt: t('careers.gallery.alt2') },
    { src: office3, alt: t('careers.gallery.alt3') },
    { src: office4, alt: t('careers.gallery.alt4') },
    { src: office5, alt: t('careers.gallery.alt5') },
    { src: office6, alt: t('careers.gallery.alt6') },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="container px-4 sm:px-6 lg:px-8 mb-24">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-black mb-8 text-center">{t('careers.gallery.title')}</h2>
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
              {t('careers.gallery.description')}
            </p>
